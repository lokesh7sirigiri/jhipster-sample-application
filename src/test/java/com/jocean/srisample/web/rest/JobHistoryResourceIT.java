...
import com.jocean.srisample.domain.JobHistory;
import com.jocean.srisample.domain.enumeration.Language;
import com.jocean.srisample.repository.JobHistoryRepository;
...
class JobHistoryResourceIT {
    ...
    private static final Language DEFAULT_LANGUAGE = Language.ENGLSH;
    private static final Language UPDATED_LANGUAGE = Language.TELUGU;
